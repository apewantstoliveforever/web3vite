            ...
            <div key={msg.id} className={`flex items-start`}>
              <Card className="flex flex-col items-start">
                {/* <Avatar className="mr-2">
                  ...
                  />
                  <AvatarFallback className="w-8 h-8 rounded-full bg-gray-300 text-white flex items-center justify-center">
                    {selectedFriend && selectedFriend[0].toUpperCase()}
                  </AvatarFallback>
                </Avatar> */}
                <CardHeader className="flex flex-row items-start space-x-4">
                  <CardTitle className="text-left">{msg.who}</CardTitle>
